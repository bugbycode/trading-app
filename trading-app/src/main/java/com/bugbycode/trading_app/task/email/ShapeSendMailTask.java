 ...
 * 发送邮件任务
 */
public class ShapeSendMailTask implements Runnable {

	private final Logger logger = LogManager.getLogger(ShapeSendMailTask.class);
	...
	public ShapeSendMailTask(String subject, String text, String recvEmail) {
