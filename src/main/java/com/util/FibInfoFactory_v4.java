...
public class FibInfoFactory_v4 {
	...
	public FibInfoFactory_v4(List<Klines> list, List<Klines> list_15m) {
	...
	private void init(boolean loadParent) {
		...
		if(openFlag != null) {
			...
			if(mode == QuotationMode.LONG) {
				...
				levelPrice = openFlag.getLowPriceDoubleValue();
			} else {
				openFlag = PriceUtil.getMaxPriceKLine(openSubList);
				levelPrice = openFlag.getHighPriceDoubleValue();
			}
		}
