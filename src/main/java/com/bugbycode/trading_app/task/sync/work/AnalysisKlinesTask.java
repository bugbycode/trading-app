...
public class AnalysisKlinesTask implements Runnable{
    ...
    public void run() {
        try {
            ...
            //盘整区分析
            klinesService.consolidationAreaMonitor(klines_list_1h_db, klines_list_15m, klines_list_15m);
            
            //量价分析
            //klinesService.volumeMonitor(klines_list_1d, klines_list_4h_db, klines_list_1h, klines_list_15m);
            
            //期权交易机会监控
            klinesService.eoptionMonitor(klines_list_1d, klines_list_1h_db, klines_list_15m);
