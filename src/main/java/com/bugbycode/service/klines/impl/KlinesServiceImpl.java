...
import com.util.FibInfoFactory_v7;
...
public class KlinesServiceImpl implements KlinesService {
			...
			if(pair.endsWith("USDT")) {
				...
				for(User u : userList) {
					...
					try {
						...
						if((autoTradeType == AutoTradeType.FIB_RET || autoTradeType == AutoTradeType.AREA_INDEX) && fibInfo != null) {
	...
	public void futuresFibMonitor(List<Klines> list, List<Klines> list_15m) {
		...
		FibInfoFactory_v7 factory = new FibInfoFactory_v7(list, list_15m);
