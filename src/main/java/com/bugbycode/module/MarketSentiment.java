...
public class MarketSentiment {
	...
	public Klines getMaxBodyLow() {
		return maxBodyLow;
	}

	public Klines getMinBodyHigh() {
		return minBodyHigh;
	}
	...
	public double getMinBodyHighPrice() {
		return minBodyHigh == null ? 0 : minBodyHigh.getBodyHighPriceDoubleValue();
	}
