...
public class FibInfo {
	...
	private TradeFrequency frequency = TradeFrequency.LOW;
	...
	public FibCode getTakeProfit_v2(FibCode code) {
		...
		if(frequency == TradeFrequency.HIGH) {
			if(code == FibCode.FIB4_618) { // 4.618 - 1
				takeProfit = FibCode.FIB1;
			} else if(code == FibCode.FIB3_618) { // 3.618 - 1
				takeProfit = FibCode.FIB1;
			} else if(code == FibCode.FIB2_618) { // 2.618 - 1
				takeProfit = FibCode.FIB1;
	...
	public FibCode getTakeProfit_v1(FibCode code) {
		FibCode takeProfit = FibCode.FIB0;
		if(frequency == TradeFrequency.HIGH) {
			if(code == FibCode.FIB4_618) { // 4.618 - 1.272
				takeProfit = FibCode.FIB1_272;
			} else if(code == FibCode.FIB3_618) { //3.618 - 1.272
				takeProfit = FibCode.FIB1_272;
