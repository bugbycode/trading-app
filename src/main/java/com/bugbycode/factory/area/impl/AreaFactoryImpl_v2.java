...
public class AreaFactoryImpl_v2 implements AreaFactory {
	...
	public AreaFactoryImpl_v2(List<Klines> list_trend, List<Klines> list, List<Klines> list_15m) {
	...
	public AreaFactoryImpl_v2(Klines list_trend_last, List<Klines> list, List<Klines> list_15m) {
		this.ps = PositionSide.DEFAULT;
		this.list = new ArrayList<Klines>();
		this.list_15m = new ArrayList<Klines>();
		this.list_trend = new ArrayList<Klines>();
