 ...
 */
public class AreaFibInfoFactoryImpl implements AreaFibInfoFactory {
	 ...
	 */
	public AreaFibInfoFactoryImpl(List<Klines> list, List<Klines> list_trend, List<Klines> list_15m) {
	...
	private void init() {
		...
		AreaFibInfoFactory parentFactory = new ParentAreaFibInfoFactoryImpl(list, list_trend, list_15m);
		
		if(!(parentFactory.isLong() || parentFactory.isShort())) {
			return;
		}
