...
public class ParentAreaFibInfoFactoryImpl implements AreaFibInfoFactory {
	 ...
	 */
	public ParentAreaFibInfoFactoryImpl(List<Klines> list, List<Klines> list_trend, List<Klines> list_15m) {
