 ...
 * 价格行为指标接口实现类
 */
public class PriceActionFactoryImplPlus implements PriceActionFactory{
	...
	private void init() {
		...
		if(fibEnd != null) {
			...
			addPrices(new OpenPriceDetails(this.fibInfo.getFibCode(fibEnd.getOpenPriceDoubleValue()), fibEnd.getOpenPriceDoubleValue()));
