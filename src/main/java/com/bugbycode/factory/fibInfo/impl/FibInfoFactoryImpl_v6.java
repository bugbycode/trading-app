 ...
 */
public class FibInfoFactoryImpl_v6 implements FibInfoFactory {
	 ...
	 */
	public FibInfoFactoryImpl_v6(List<Klines> list, List<Klines> list_trend, List<Klines> list_15m) {
	...
	private void init() {
		...
		FibInfoFactoryImpl factory = new FibInfoFactoryImpl(list, list_trend, list);
